...
public class ExtendedBindingHandlerMappingsProviderConfiguration {
	...
	@Bean
	public MappingsProvider liiklusExtendedPropertiesDefaultMappingsProvider() {
		return () -> {
			Map<ConfigurationPropertyName, ConfigurationPropertyName> mappings = new HashMap<>();
			mappings.put(
					ConfigurationPropertyName.of("spring.cloud.stream.liiklus.bindings"),
					ConfigurationPropertyName.of("spring.cloud.stream.liiklus.default"));
			return mappings;
		};
	}
